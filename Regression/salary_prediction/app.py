...
model = pickle.load(open(r'C:\Users\HP\Desktop\ML code\Regression\salary_prediction\linear_regression_model.pkl', 'rb'))

# Set the title of the Streamlit app
st.title("Salary Prediction App created by Sibananda jena")
